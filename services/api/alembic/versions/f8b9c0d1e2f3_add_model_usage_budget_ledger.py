...
def upgrade() -> None:
    ...
    op.create_index("ix_model_usage_record_execution_run", "model_usage_record", ["execution_run_id"])
    op.create_index("ix_model_usage_record_runtime_run", "model_usage_record", ["runtime_run_id"])
