...
_PACKAGES: dict[str, ScenarioPackage] = {
    "bidpilot": ScenarioPackage(
        ...
        drafting_system_prompt=(
            "You are a professional proposal writer. Write clear, evidence-backed "
            "sections in markdown. Cite specific evidence where appropriate."
        ),
    ),
    "contractpilot": ScenarioPackage(
        ...
        drafting_system_prompt=(
            "You are a contract analyst. Identify key obligations, risks, and "
            "compliance requirements. Write clear, structured analysis in markdown "
...
def list_scenarios() -> list[dict[str, str]]:
    return [
        {"key": package.key, "label": package.label, "description": package.description}
