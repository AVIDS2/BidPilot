...
import { AIAssistantProvider } from "@/lib/ai-assistant-store";
...
export function WorkbenchV2Layout() {
  ...
  return (
    <AIAssistantProvider>
      <TooltipProvider>
        <AgentWakeResume />
        <div
          className={cn("workbench-v2", isResizing && "is-resizing", sidebarCollapsed && "is-sidebar-collapsed")}
